...
int main() {
    ...
    /*
     * not possible:
     * auto ti_dummy = make_shared_TaskIndependentComponent<Dummy>(666);
     */
    auto ti_eager = make_shared_TaskIndependentComponent<eager_search::EagerSearch, SearchAlgorithm>(std::tuple(ti_sum_eval, dummy_ptr, "eager"/*1*/, utils::Verbosity::NORMAL));
